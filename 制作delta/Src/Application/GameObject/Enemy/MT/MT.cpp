...
void MT::Update()
{
	...
	if (flg) {
		Application::Instance().m_log.AddLog("MTGround\n");
	}
	else {
		Application::Instance().m_log.AddLog("MTFallNow\n");
	}
...
void MT::PostUpdate()
{
	...
	m_pDebugWire->AddDebugBox(m_correctionMat * m_mWorld, box.Extents, {}, true);
